$(document).ready(function(){
	$("#nextOrange").click(function(){
//		$("#adPicture").fadeOut("500",nextButton());
		nextButton();
//		$("#adPicture").fadeIn("500");
	});
	
	$("#prevOrange").click(function(){
//		$("#adPicture").fadeOut("500",preButton());
		preButton();	
//		$("#adPicture").fadeIn("500");
	});
//	alert($("#adPicture"));//why is null?????
//	$("adPicture").fadeOut("slow");
//	alert($("#nextOrange"));//why is not null?????
//	$("#nextOrange").fadeOut("slow");
//	$("#adPicture").fadeOut("slow");
});

function imageFadeOut(){
	$("#adPicture").fadeOut("500");	
}
...
var setGrayElement;
var setBlueElement = document.getElementById("bulletButton1");
...
function showAdImage()
{
	...
	curtime++;
	if(curtime === interval){
		//this is the image we want to show in the php
		image = adImageList[count];
		
		$("#adPicture").fadeOut("500",function(){
